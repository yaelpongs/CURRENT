...
public class creatUserForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 340, 440));
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if(fn.getText().isEmpty() || ln.getText().isEmpty() || em.getText().isEmpty() || un.getText().isEmpty() || pw.getText().isEmpty()){
            ...
            if(dbc.insertData("INSERT INTO tbl_user(u_fname, u_lname, u_email, u_username, u_password, u_type, u_status)VALUES ('" + fn.getText() + "','" + ln.getText() + "','" + em.getText() + "',"
                    + "'" + un.getText() + "','" + pass + "','" + ut.getSelectedItem() + "','" + ut.getSelectedItem() + "')")){
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
       ...
       dbc.updateData("UPDATE tbl_user SET u_fname = '"+fn.getText()+"',u_lname = '"+ln.getText()+"',u_email = '"+em.getText()+"',u_username = '"+un.getText()+"',"
               + "u_password = '"+pass+"',u_type = '"+ut.getSelectedItem()+"',u_status = '"+us.getSelectedItem()+"' WHERE u_id = '"+uid.getText()+"'");
                userForm usf = new userForm();
                usf.setVisible(true);
                this.dispose();
    }catch(NoSuchAlgorithmException ex){
